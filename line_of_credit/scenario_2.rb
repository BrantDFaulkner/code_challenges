...
puts "Client's total balance should be $411.99."
puts "Statement: #{statement[:total_balance]}"
puts "Clients's principle balance should be 400."
puts "Statement: #{statement[:principle_balance]}"
puts "Client's interest_balance should be $11.99."
puts "Statement: #{statement[:interest_balance]}"
puts "Client's remaining credit should be $588.01."
